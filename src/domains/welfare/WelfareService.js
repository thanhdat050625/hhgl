// WelfareService: Quản lý 5 tab phúc lợi (báo danh, online, 7 ngày, tích lũy, cầu nguyện)
...
class WelfareService extends BaseService {
  ...
  async autoClaimAll() {
    console.log('\n[Auto Phúc Lợi] BẮT ĐẦU NHẬN TẤT CẢ CÁC MỤC PHÚC LỢI');
  ...
  // Kiểm tra và nhận thưởng Online
