// AffairService: Xử lý cung vụ triều đình (ưu tiên nhận Cung Vận)
...
class AffairService extends BaseService {
  ...
  // Dùng Cung Vụ Lệnh khi hết lượt miễn phí và đang cooldown
  ...
  async autoHandleAffairs(isLoop = false) {
    ...
    // Dùng Cung Vụ Lệnh khi hết lượt tự nhiên
    while (true) {
