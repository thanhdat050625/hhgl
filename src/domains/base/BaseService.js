// Base Service Class cho Domain Services (Server-Authoritative State Sync)
...
class BaseService {
  ...
  // Hook xử lý gói tin từ GameClient (override nếu cần)
  onPacket(msgId, data) {
  }

  // Phương thức thực thi hành động chính
  async execute() {
