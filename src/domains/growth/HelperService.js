// HelperService: Quản lý & bồi dưỡng tùy tùng (nâng cấp, tư chất, đề bạt, thư)
...
class HelperService extends BaseService {
  ...
  // Đọc và nhận toàn bộ thư tùy tùng
  ...
  // Tự động nâng cấp tư chất tùy tùng
  ...
  // Tự động đề bạt tước vị tùy tùng
  ...
  // Bồi dưỡng thuộc tính tối ưu cho tùy tùng (Đan, Tán, Hoàn, Quả, Sách)
