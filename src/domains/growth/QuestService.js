// QuestService: Tự động nhận thưởng nhiệm vụ chính tuyến, tước vị & năng động
...
class QuestService extends BaseService {
  ...
  async autoClaimAll() {
    console.log('\n[NHẬN THƯỞNG NHIỆM VỤ CHÍNH TUYẾN & TƯỚC VỊ]');
  ...
  // Nhận thưởng nhiệm vụ chính tuyến
  ...
  // Nhận thưởng rương năng động ngày
