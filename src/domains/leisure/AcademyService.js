// AcademyService: Tự động cho tùy tùng học tập tại Thư Viện / Học Viện
...
class AcademyService extends BaseService {
  ...
  async autoStudy(isLoop = false) {
    ...
    // Vào Học Viện & kiểm tra trạng thái
    ...
    // Nhận thưởng buổi học đã hoàn thành
    this.send(217105, {});
    await this.sleepRandom(0.8, 1.2);

    // Cho tùy tùng vào học buổi mới
