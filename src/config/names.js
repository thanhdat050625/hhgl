// Tra cứu tên tiếng Việt cho các thực thể trong game
...
function loadJsonSafe(filename) {
  const candidatePaths = [
    ...
    path.join(__dirname, '../../_source_game/config_tables', filename),
    path.resolve(__dirname, '../../../hhgl-source/_source_game/config_tables', filename),
    path.resolve(__dirname, '../../../../hhgl-source/_source_game/config_tables', filename)
  ];
